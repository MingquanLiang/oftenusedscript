...
new_python_version="python3.4"

if [[ "$1" != "base" && "$1" != "extra" && "$1" != "service" ]]
then
    echo "Syntax: $0 [base|extra|service]"
...
then
    ...
    cd ${installation_dir}
    python3_source="Python-3.4.3.tar.xz"
...
then
    ...
    1) pip3.4 install pymysql
    2) add "import pymysql; pymysql.install_as_MySQLdb()" into project_name/__init__.py
    3) python manage.py migrate
    '
    echo "
    [root@localhost performance-analysis]# pip3.4 install pymysql
    Collecting pymysql
