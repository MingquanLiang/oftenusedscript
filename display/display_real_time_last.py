...
class PlotFigure(wx.Frame):
    def __init__(self):
        ...
        #TODO:self.fig = Figure((21, 9), 90)
        self.fig = Figure((21.34, 10.98), 90)
        ...
        self.average.set_xlim(Y_MIN_VALUE, 350000)
        ...
        self.fig.subplots_adjust(left=0.08, right=0.95, bottom=0.08, top=0.95)
        #self.fig.subplots_adjust(left=0.10, right=0.95, bottom=0.08, top=0.95)
        ...
        self.ax.set_position([0.08, 0.43, 0.85, 0.55])
        self.average.set_position([0.08, 0.08, 0.85, 0.28])
